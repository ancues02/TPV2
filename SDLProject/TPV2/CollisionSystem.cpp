...
//se comprueban las colisiones de los asteroides activos con el fighter y luego con las balas
//si hay colision se llaman a los correspondientes metodos
void CollisionSystem::update()
{
	...
	for (auto& a : mngr_->getGroupEntities(ecs::_grp_Asteroid)) {
		if (a->isActive()) {
			...
			//colision entre asteroide y fighter
